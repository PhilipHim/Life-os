  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="mb-8 line-clamp-2 text-lg text-gray-300 sm:mb-10 sm:text-xl">{activeSession.taskTitle}</p>
        <p className="mb-8 font-mono text-5xl font-light tracking-wider text-white sm:mb-12 sm:text-7xl md:text-8xl">
          {formatTime(elapsed)}
        </p>
